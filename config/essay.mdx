...
<Block id="country" legend="Over 11,000 respondents from 102 countries all over the world."/>
...
<Block id="css_in_js_section_streams" legend="Most CSS-in-JS libraries show a positive trend over the past year"/>
...
<Block id="css_in_js_experience_marimekko"/>
