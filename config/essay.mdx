...
import SectionLink from 'core/essay/EssaySectionLink'
...
<Block id="css_frameworks_abridged_experience_ranking" size="l" title="CSS Frameworks Rankings">
...
<SectionLink path="/technologies/css-frameworks/">View Full Results: CSS Frameworks »</SectionLink>
...
<Block id="utility_classes_to_be_avoided" size="s" title="Do you agree that utility classes should be avoided?"/>
...
<Block id="css_is_programming_language" title="Do you agree that CSS is a programming language?" size="s"/>
