...
<Block id="css_frameworks_experience_ranking">
    <Overlay id="satisfaction">Tailwind CSS took the top spot in our satisfaction rankings (defined as the proportion of users of a technology who would use it again).</Overlay>
    <Overlay id="interest">When looking at interest rates (the proportion of non-users interested in learning a technology), Bootstrap falls dramatically to last place…</Overlay>
...
<Block id="utility_classes_to_be_avoided" />
...
<Block id="scatterplot_overview" legend="Tailwind CSS might soon enter the “Adopt” quadrant." />
