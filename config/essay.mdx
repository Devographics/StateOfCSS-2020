...
<Block id="country" size="l">
    <Overlay id="USA">Over 11,000 respondents from 102 countries took part in the survey, with a large chunk (**20.7%**) coming from the U.S.</Overlay>
    <Overlay id="RUS">
